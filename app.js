    ...
    $.ajax({
        ...
        for (i = 0; i < response.offices.length; i++) {
            ...
            if (i < 2) {
                ...
                var repNameDiv = $("<p>").append(repName + " (" + repParty + ")<br />" + "<span style='color:#eb6572;'>" + repPhone + "</span>" + "<br />" + repAddress2 + "<br />" + "<a href='" + repUrl + "' target='_blank'>" + repUrl + "</a>");
                ...
                if (response.officials[i].address[0].line2) {
                    ...
                    var repNameDiv = $("<p>").append(repName + " (" + repParty + ")<br />" + "<span style='color:#eb6572;'>" + repPhone + "</span>" + "<br />" + repAddress + "<br />" + "<a href='" + repUrl + "' target='_blank'>" + repUrl + "</a>");
                }
                if (response.officials[i + 1].address[0].line2) {
                    var repNameDiv2 = $("<p>").append(repName2 + " (" + repParty + ")<br />" + "<span style='color:#eb6572;'>" + repPhone2 + "</span>" + "<br />" + repAddress3 + "<br />" + "<a href='" + repUrl2 + "' target='_blank'>" + repUrl2 + "</a>");
                } else {
                    var repNameDiv2 = $("<p>").append(repName2 + " (" + repParty + ")<br />" + "<span style='color:#eb6572;'>" + repPhone2 + "</span>" + "<br />" + repAddress4 + "<br />" + "<a href='" + repUrl2 + "' target='_blank'>" + repUrl2 + "</a>");
                }
                ...
                var repDivTitle = $("<h3>").append(response.offices[i].name);
                if (response.officials[i + 1].address[0].line2) {
                    var repNameDiv = $("<p>").append(repName2 + " (" + repParty2 + ")<br />" + "<span style='color:#eb6572;'>" + repPhone2 + "</span>" + "<br />" + repAddress3 + "<br />" + "<a href='" + repUrl2 + "' target='_blank'>" + repUrl2 + "</a>");
                } else {
                    var repNameDiv = $("<p>").append(repName2 + " (" + repParty2 + ")<br />" + "<span style='color:#eb6572;'>" + repPhone2 + "</span>" + "<br />" + repAddress4 + "<br />" + "<a href='" + repUrl2 + "' target='_blank'>" + repUrl2 + "</a>");
                }
                var repInfoDiv = $("<div>").append(repNameDiv);
                repDiv.append(repDivTitle);
                repDiv.addClass("rep animated bounceInUp");
